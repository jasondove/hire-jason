...
export default function Body() {
	...
	const data = [
		{
			title: <span>
				Hi. My name is <a href="#" className="name" onClick={handleNameClick}>Jason Dove</a> and I'd like to
	...
	return (
		<div className="body-container">
			...
			<ImgBox currentView={view} transitioning={transitioning} imgEffect={imgEffect} />
